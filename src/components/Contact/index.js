...
const Contact = () => (
  <ContactContainer>
    <ContactParallax className='section fifth-content parallax-window' id='contacto' bgImage={Image} strength={500}>
        ...
        <div className='column is-10-tablet is-12-mobile'>
          <div className='columns is-mobile is-multiline'>
            <div className='column is-6-tablet is-12-mobile'>
              ...
              <br />
              <Icons className='columns is-multiple is-mobile is-vcentered'>
